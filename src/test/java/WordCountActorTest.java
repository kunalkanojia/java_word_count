...
public class WordCountActorTest {
    ...
    public void testWordCount() {
        new JavaTestKit(system) {{
            ...
            masterActor.tell(new WordCountActor.StartCounting("src/main/resources/", 20), getTestActor());
            ...
            new Within(duration("20 seconds")) {
                protected void run() {
                    ...
                    assertThat(wcs.result, IsMapContaining.hasEntry("src/main/resources/File1.txt", 6480000));
                    assertThat(wcs.result, IsMapContaining.hasEntry("src/main/resources/File2.txt", 6480000));
                }
            };
        }};
    }
